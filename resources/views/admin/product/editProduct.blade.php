			...
			<div class="well">
				...
				<form method="POST" name="editProductForm" enctype="multipart/form-data" action="{{ url('/product/update') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control" value="{{ $productById->productShortDescription }}" name="productShortDescription">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control" value="{{ $productById->productLongDescription }}" name="productLongDescription">
